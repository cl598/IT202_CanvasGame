...
function menu() {
    ...
    context.fillText('Use the WASD keys to move', canvas.width / 2, (canvas.height / 4) * 3);

    // Start the game on a click
    canvas.addEventListener('click', startGame);
}

// Sound Constructor (W3SCHOOLs) **
function sound(src) {
...
function startGame() {
    ...
    // Sound effect audio **
    soundEffect = new sound("Audio/Gravel_Sound.mp3");

    // Battle music audio **
    battleMusic = new sound("Audio/Battle.mp3");
    battleMusic.play();
